...
import { TicketLocationCount } from "./hooks/pieChart3";
...
return (
  <Box className="chart-container">
    <h2 className='chart-title'>Ubicación de los Tickets</h2>
    {
      isSmall ?
        <TicketLocationSmall data={res.data}/> :
        <TicketLocation data={res.data}/> 
    }
  </Box>
);
}
...
const TicketLocation = ({data}: {data: IReport[]}) => (
...
const TicketLocationSmall = ({data}: {data: IReport[]}) => (
